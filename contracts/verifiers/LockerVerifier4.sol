...
contract LockerVerifier4 is IVerifier {
    
    uint32 constant n =   16384;
    uint16 constant nPublic =  5;
    uint16 constant nLagrange = 5;
    
    uint256 constant Qmx = 1937352270184408282176737727452855913441600773415415387783460533718675417910;
    uint256 constant Qmy = 13663511432451070710747436442996223744372640477272167305320797510850905319774;
    uint256 constant Qlx = 18426502053161213915409514744174769194454472264941418290547042362212252908218;
    uint256 constant Qly = 16803675660815357317401092940553777355226040535857451793552755013561580594370;
    uint256 constant Qrx = 4764632968138821185469024398138247791149217410352831967094516669019500408949;
    uint256 constant Qry = 17346561565480434183504790954402172628398025823283444993017535967885481054916;
    uint256 constant Qox = 3264681083935158028976805951202533965799626411319533821855673603747124226166;
    uint256 constant Qoy = 4141686852428151219592980222430262319096753748787383779952314727203468639930;
    uint256 constant Qcx = 17099356922731517580867523253088009968147536037370834815174309559723415535974;
    uint256 constant Qcy = 87830152568936152673620643512514526823356349181335917899884845691868774088;
    uint256 constant S1x = 10141477856581546246192640841684841183662648192975538606872168243531500744363;
    uint256 constant S1y = 384826681791722990866361653898366334651499127234644372588720464115536127740;
    uint256 constant S2x = 8363079978728043853146826568517332542527400472424627574119802452944992387936;
    uint256 constant S2y = 6896669660324421238149652380560120943997409026312283934792030831981031201278;
    uint256 constant S3x = 17830631315356578300214683768570461987217692989387501306367040817262407450568;
    uint256 constant S3y = 4887263014159328879576890478725858151626292745447153594359234046378905498297;
